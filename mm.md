...
| 添加审批人 | 删除审批模板 | 模板没有绑定审批操作 | 删除审批模板。 |
| 编辑审批人 | ![](/assets/icon-edit.png) | 资费模板还未关联产品 | 除产品类型外，其他设置均可更改。 |
| 删除 | ![](/assets/icon-delete.png) | 资费模板还未关联产品 | 删除资费模板。 |
| 复制 | ![](/assets/icon-copy.png) | -- | 复制资费模板，资费名称不可与已存在的模板重复。 |


操作对应图标描述修改审批模板可修改审批模板名称和审批时限。删除前提条件：模板没有绑定审批操作。编辑审批人点击审批人下方的编辑按钮，可对已有的审批人进行更改，可更改为同一项目下别的租户管理员owner或是别的项目下的租户管理员owner。删除审批人点击审批人下方的删除按钮，可删除现有审批人，前提条件是现有审批人个数>=2。添加审批人添加审批人点击审批人右侧的“添加审批人”按钮，可增添新的审批人以及调整审批人的顺序，重新制定当前审批模板的审批流程。其中，新增的审批人可以是同一项目下别的租户管理员owner或是别的项目下的租户管理员owner。绑定操作点击已绑定操作右侧的“绑定操作”按钮，可增添一到多个新的项目下的操作到审批模板，可选的审批操作包括：创建/更新虚拟机，创建/扩展卷，关联floatingip，更新floatingip带宽。修改绑定操作点击已绑定操作右侧的修改按钮，可更改已绑定项目下的审批操作。下图为审批模板test的详细页面的”添加审批人”操作框:添加新的审批人后可点击右下角的上下箭头可调整审批人顺序，重新制定模板的审批流程。
