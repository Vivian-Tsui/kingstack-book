...
在详情页，可针对计算节点、物理机和控制节点执行监控项迁移操作，并且可批量迁移计算节点的监控项。
...
点击列表右上方的“创建子监控服务器”按钮，在弹窗中输入监控服务器名称、选择关联物理机、填写用户名及密码，之后选择监控模板和通知组（通知组可暂不选择），点击“确定”按钮创建监控服务器。

#### 9.10.2.2 子监控服务器详情 {#9-10-2-2}

点击子监控服务器名称可进入详情页，在此可查看zabbix sever当前所监控的计算节点、物理机、控制节点，以及交换机等。 
