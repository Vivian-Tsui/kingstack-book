...
选择左侧导航栏的“管理->项目管理”列表，点击右侧牙面右上角的“创建项目”按钮，弹出创建项目窗口，填写项目名称，选择要绑定的资源池（可绑定一个或多个资源池），勾选启用，点击“创建项目”完成创建。
...
| 操作 | 对应按钮 | 前提条件 | 描述 |
| :--- | | :--- | | :--- | | :--- |
| 编辑名称 | ![](/assets/icon-edit.png) | -- | 修改告警过滤规则的名称、描述、维护期，以及是否为public |
